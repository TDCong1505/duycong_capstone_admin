...
export const GET_DATA_USER_IDENTIFICATION = 'GET_DATA_USER_IDENTIFICATION';
...
export const GET_NEW_CATEGORY_BLOG = 'GET_NEW_CATEGORY_BLOG';

export const GET_DATA_SETTING = 'GET_DATA_SETTING';

export const GET_DATA_MAILSUPPORT = 'GET_DATA_MAILSUPPORT';

export const GET_DATA_BANNERS = 'GET_DATA_BANNERS';

export const GET_DATA_COMPANY = 'GET_DATA_COMPANY';
